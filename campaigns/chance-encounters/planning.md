...
description: Living planning document for Chance Encounters. The primary source for session-prep and run-session. Updated each wrap-session.
---

*This doc is the prep. Read `dm-philosophy.md` for why it's structured this way.*
...
|---|---|---|---|
| White Gull captain's window | — | 4 / 4 🔴 RESOLVED | He walked there on purpose. Received by Ariel. Arc closed. |
...
| [[tjorvi]] | For the promise to be kept; for the crew in the back to be honored | That there's no way to free them | Gifted the cord so the party didn't leave with something stolen |
...
- ~~What did Elara + Wrenn do overnight?~~ **Answered:** Loyal; searching for captain; Elara becomes new captain at Reckoning close.
- ~~What does the absorbed White Gull captain look like?~~ **Answered:** Walked there on purpose; Ariel received him; arc closed.
...
- **Eld entity (Cypher)** — Casus made incidental contact; the entity's agenda is unknown. Let it surface from play; do not predecide.
